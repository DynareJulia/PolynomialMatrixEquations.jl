...
#"""
function gs_solver!(ws::GsSolverWs, d::Matrix{Float64}, e::Matrix{Float64}, n1::Int64, qz_criterium)
    # select eigenvalues inside interior disk with criterium radius (slightly below or above one)
    gges!(ws.schurws, 'N', 'V', e, d, select = FastLapackInterface.id, criterium = qz_criterium)
